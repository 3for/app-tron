...
```bash
python3 tool/generate_nanox_docx.py \
  --source tests/ragger/snapshots/nanox \
  --output tool/nanox_snapshots.docx \
...
python3 tool/generate_nanox_docx.py \
  ...
  --output tool/nanosp_snapshots.docx \
...
python3 tool/generate_nanox_docx.py \
  ...
  --output tool/flex_snapshots.docx \
...
python3 tool/generate_nanox_docx.py \
  ...
  --output tool/stax_snapshots.docx \
...
python3 tool/generate_nanox_docx.py \
  ...
  --output tool/apex_p_snapshots.docx \
