...
#define EXCHANGE_TOKEN_NAME_MAX_LENGTH  31
#define EXCHANGE_TOKEN_LABEL_MAX_LENGTH (EXCHANGE_TOKEN_NAME_MAX_LENGTH + TOKENID_SIZE + 2)
#define EXCHANGE_PAIR_SEPARATOR_LENGTH  4
#define EXCHANGE_PAIR_REVIEW_SIZE \
    ((2 * EXCHANGE_TOKEN_LABEL_MAX_LENGTH) + EXCHANGE_PAIR_SEPARATOR_LENGTH + 1)
