...
# Mirrors app-ethereum's gating descriptor builder
# (client/src/ledger_app_clients/ethereum/gating.py). The wire TX_TYPE value is 0
# for a transaction and 1 for typed data (the firmware stores type = value + 1).
