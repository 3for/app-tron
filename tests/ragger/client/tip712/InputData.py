...
def send_coin_meta_certificate(app_client) -> None:
    ...
    if app_client._device.type == DeviceType.NANOSP:
    ...
    elif app_client._device.type == DeviceType.NANOX:
    ...
    elif app_client._device.type == DeviceType.STAX:
    ...
    elif app_client._device.type == DeviceType.FLEX:
    ...
    elif app_client._device.type == DeviceType.APEX_P:
        ...
        print(f"Invalid device '{app_client._device.name}'")
        cert_apdu = ""
